...
class Attendance:
    def __init__(self, root):
        ...
        img_left = Image.open(r"C:\face_recognition system\college_images\AdobeStock_303989091.jpeg")
        ...
        atten_name.grid(row=1, column=1, pady=8)  # Corrected column index to 0
    ...
    def update_data(self):
        # Get the selected row from treeview
        cursor_row = self.AttendanceReportTable.focus()
        if not cursor_row:
