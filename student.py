...
class Student:
    def __init__(self,root):
        ...
        course_combo["values"]=("Select Course","BBA","BCA","BCOM")
        ...
        btn_frame1.place(x=180,y=235,width=715,height=35)
        ...
        Right_frame.place(x=750,y=10,width=850,height=580)
    ...
    # =====================fetch data=====================
    def fetch_data(self):
        conn=mysql.connector.connect(host="localhost",username="root",password="2407",database="face_recognizer")
        my_cursor=conn.cursor()
            ...
            try:
                ...
                while True:
                    ...
                    if face_cropped(my_frame) is not None:
                        ...
                        file_name_path = f"data/user.{id}.{img_id}.jpg"  # Note: Corrected the filename format
